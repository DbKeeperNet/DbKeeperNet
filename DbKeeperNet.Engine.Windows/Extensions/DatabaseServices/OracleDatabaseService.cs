...
using DbKeeperNet.Engine.Windows.Extensions.Preconditions;
...
namespace DbKeeperNet.Engine.Windows.Extensions.DatabaseServices
{
    ...
    /// <list type="bullet">
    /// <item><see cref="DbKeeperNet.Engine.Extensions.Preconditions.DbForeignKeyNotFound"/></item>
    /// <item><see cref="DbKeeperNet.Engine.Extensions.Preconditions.DbIndexNotFound"/></item>
    /// <item><see cref="DbKeeperNet.Engine.Extensions.Preconditions.DbPrimaryKeyNotFound"/></item>
    /// <item><see cref="DbKeeperNet.Engine.Extensions.Preconditions.DbProcedureNotFound"/></item>
    /// <item><see cref="DbKeeperNet.Engine.Extensions.Preconditions.DbTableNotFound"/></item>
    /// <item><see cref="DbKeeperNet.Engine.Extensions.Preconditions.DbTriggerNotFound"/></item>
    /// <item><see cref="DbKeeperNet.Engine.Extensions.Preconditions.DbViewNotFound"/></item>
    /// <item><see cref="OraDbSequenceNotFound"/></item>
    /// </list>
    /// </remarks>
    /// <example>
    ...
    public sealed class OracleDatabaseService : DisposableObject, IDatabaseService
    {
        ...
        {
            get { return typeof(OracleDatabaseService).GetTypeInfo().Assembly.GetManifestResourceStream(@"DbKeeperNet.Engine.Windows.Extensions.DatabaseServices.OracleDatabaseServiceInstall.xml"); }
        }
