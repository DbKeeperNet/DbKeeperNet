...
namespace DbKeeperNet.Engine.Windows.Extensions.DatabaseServices
{
    ...
    public class MySqlNetConnectorDatabaseService : DisposableObject, IDatabaseService
    {
        ...
        {
            get { return typeof(MySqlNetConnectorDatabaseService).GetTypeInfo().Assembly.GetManifestResourceStream(@"DbKeeperNet.Engine.Windows.Extensions.DatabaseServices.MySqlNetConnectorDatabaseServiceInstall.xml"); }
        }
