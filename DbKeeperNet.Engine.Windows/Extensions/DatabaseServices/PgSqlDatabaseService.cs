...
namespace DbKeeperNet.Engine.Windows.Extensions.DatabaseServices
{
    ...
    public class PgSqlDatabaseService: DisposableObject, IDatabaseService
    {
        ...
        {
            get { return typeof(PgSqlDatabaseService).GetTypeInfo().Assembly.GetManifestResourceStream(@"DbKeeperNet.Engine.Windows.Extensions.DatabaseServices.PgSqlDatabaseServiceInstall.xml"); }
        }
