...
namespace DbKeeperNet.Engine.Windows.Tests.Extensions.DatabaseServices
{
    ...
    public class FirebirdDatabaseServiceLiveTests: DatabaseServiceTests<FirebirdDatabaseService>
    {
        ...
        public void Setup()
        {
            ...
            updater.ExecuteXml(typeof(DbServicesExtension).Assembly.GetManifestResourceStream(@"DbKeeperNet.Engine.Windows.Extensions.DatabaseServices.FirebirdDatabaseServiceInstall.xml"));
        }
