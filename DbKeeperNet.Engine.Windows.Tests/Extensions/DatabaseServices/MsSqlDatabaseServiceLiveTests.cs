...
namespace DbKeeperNet.Engine.Windows.Tests.Extensions.DatabaseServices
{
    ...
    public class MsSqlDatabaseServicesLiveTests : DatabaseServiceTests<MsSqlDatabaseService>
    {
        ...
        public void Setup()
        {
            ...
            updater.ExecuteXml(typeof(DbServicesExtension).Assembly.GetManifestResourceStream("DbKeeperNet.Engine.Windows.Extensions.DatabaseServices.MsSqlDatabaseServiceInstall.xml"));
        }
