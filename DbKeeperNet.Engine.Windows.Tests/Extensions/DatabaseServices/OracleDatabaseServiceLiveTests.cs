...
namespace DbKeeperNet.Engine.Windows.Tests.Extensions.DatabaseServices
{
    ...
    public class OracleDatabaseServicesLiveTests : DatabaseServiceTests<OracleDatabaseService>
    {
        ...
        public void Setup()
        {
            ...
            updater.ExecuteXml(typeof(DbServicesExtension).GetTypeInfo().Assembly.GetManifestResourceStream("DbKeeperNet.Engine.Windows.Extensions.DatabaseServices.OracleDatabaseServiceInstall.xml"));
        }
